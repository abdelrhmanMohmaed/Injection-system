                        ...
                        <table class="table table-striped table-bordered table-hover dataTable myTable">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>{{$item->ejector_side}}</td>
                                    <td>{{$item->nozzle_side}}</td>
                                    <td>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('createParam/MouldTemp')}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="ejector_side">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">{{ __('Nozzle Side') }}</label>
                                                        <input class="form-control" name="nozzle_side">
                                                    </div>
                                                </div>
                                            </div>
