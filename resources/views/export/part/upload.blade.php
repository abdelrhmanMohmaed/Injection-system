            ...
            <div class="col-xs-12">
                <div class="box box-solid box-primary">
                    <div class="box-header">
                        <h3 class="box-title">
                            <i class="fa fa-list-alt"></i> &nbsp; Export Part Number By Excel
                        </h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body table-responsive">
                        <form action="{{route('exports.uploadPartData')}}" enctype="multipart/form-data" method="post">
                            @csrf
