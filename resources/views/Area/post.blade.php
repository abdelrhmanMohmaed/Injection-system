                ...
                <div class="row content">
                    ...
                    <div class="col-xl-12 col-md-12 m-b-30">
                       ...
                       <ul class="nav my-class nav-tabs" id="myTab1" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active show1" id="user-tab" data-toggle="tab" href="#postTab"
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select onchange="getParameters()" id="partNumberPost" required
                                                                class="form-control selectpicker" data-live-search="true" name="part_id">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" required placeholder="Counter"
                                                               class="form-control" name="counter">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">{{ __('IO') }}</label>
                                                        <input type="number" required placeholder="IO"
                                                               class="form-control" name="io">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">{{ __('NIO') }}</label>
                                                        <input type="number" class="form-control" required
                                                               placeholder="NIO" name="nio">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="name">{{ __('Cycle Time') }}</label>
                                                        <input class="form-control" required placeholder="Cycle Time"
                                                               name="cycle_time">
                                                        <input type="hidden" class="form-control"
                                                               value="{{$machine->id}}" name="machine_id">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                        ...
                        <div class="media-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" value="{{$machine->id}}"
                                           name="machine_id">
                                </div>
                            </div>
                            <div class="form-group text-center">
                                <button type="submit" id="makePost" style="margin-top: 23px;" class="btn btn-info">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#makePost').click(function (e) {
        e.preventDefault();
        var formData=$('#createPost').serializeArray();
        $.ajax({
            type: 'post',
            url: '{{url('create/post')}}',
            data:formData,
    ...
    function getParameters(type = null) {
        ...
        var url = '{{url('get/part/parameters')}}/' + part + '/{{$machine->id}}';
        if (type) {
            url = '{{url('get/part/parameters')}}/' + part + '/{{$machine->id}}/' + type;
        }
        $.ajax({
            type: 'get',
            url: url,
