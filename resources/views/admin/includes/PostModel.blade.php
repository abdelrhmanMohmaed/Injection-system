...
<div class="modal fade bd-example-modal-lg" id="postModel"  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                           ...
                                           <ul class="nav my-class nav-tabs" id="myTab1" role="tablist">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select @change="getParameters()" id="partNumberPost" required
                                                                                    class="form-control" name="part_id">
                                                                                <option value="">Select Part</option>
                                                                                {{--@foreach($machine->parts as $part)--}}
                                                                                    <option v-for="part in post.machine.parts" v-bind:value="part.id">@{{part.part_no}}</option>
                                                                                {{--@endforeach--}}
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="form-group text-center">
                                                    <button type="submit" @click.prevent="createPost()" style="margin-top: 23px;" class="btn btn-info">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
