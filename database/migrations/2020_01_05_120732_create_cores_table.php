...
class CreateCoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cores', function (Blueprint $table) {
            ...
            $table->string('fwd_speed')->nullable();
            $table->string('fwd_pressure')->nullable();
            $table->string('interval_speed')->nullable();
            $table->string('interval_pressure')->nullable();
            $table->string('bwd_speed')->nullable();
            $table->string('bwd_pressure')->nullable();
